 ...
 *
 * @author Slava Pestov
 * @version $Id: JEditTextArea.java,v 1.1.1.1 2001/12/20 10:01:44 tysinsh Exp $
 */
public class JEditTextArea extends JComponent
{
        ...
        public void mouseWheelMoved(MouseWheelEvent e)
        {
          int direction = e.getWheelRotation() < 0 ? -1 : 1;
            ...
            if (e.getScrollType() == MouseWheelEvent.WHEEL_UNIT_SCROLL)
            {
                ...
                {
                   setFirstLine(vertical.getValue() + direction * e.getScrollAmount());
                }
                else
                {
                   setHorizontalOffset(-horizontal.getValue() + direction * e.getScrollAmount());
                }
            }
  ...
  public void setFirstLine(int firstLine)
  {
    if(firstLine == this.firstLine ||
            firstLine < 0 ||
            firstLine > vertical.getMaximum() - getVisibleLines())
    {
       return;
    }

 ...
 *
 * @author Slava Pestov
 * @version $Id: SyntaxDocument.java,v 1.1.1.1 2001/12/20 10:01:45 tysinsh Exp $
 */
public class SyntaxDocument extends PlainDocument implements UndoableEditListener
{
    ...
    */
     ...
     * Compound edit
     */
    protected CompoundEdit compound_edit = null;
    ...
    /**
     * Returns undo manager for this syntax document
      * @return undo manager for this syntax document
     */
    ...
    {
        if ( compound_edit != null )
        {
            compound_edit.end();
            undo.addEdit( compound_edit );
            compound_edit = null;
        }
    }
	/**
    ...
    public void undoableEditHappened(UndoableEditEvent e)
    {
        if ( e.getSource() == this )
        {
            if ( compound_edit != null )
            {
                compound_edit.addEdit( e.getEdit() );
            }
            else
            {
